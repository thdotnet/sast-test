...
namespace SAST
{
	public static class ComputerVisionFunction
	{
		...
		public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route= null)] HttpRequest req, ILogger log)
		{
			...
			var client = new ComputerVisionClient(new ApiKeyServiceClientCredential("AX1234B52Z669"));
			client.Endpoint = "https://thiago-test-environment.azurewebsites.net";

			var results = await client.AnalyzeImagesAsync(url, new List<VisualFeaturesTypes() {
